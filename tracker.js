...
export const getPeers = (torrent, callback) => {
  ...
  socket.on('message', function (data ) {
    ...
    if (respType(data) === 'connect') {
      ...
      console.log('parseConnResp finished - action ' , connResp.action , "\ntransaction id : " , connResp.transactionId , "\nconncetion id : " , connResp.connectionId);
      ...
      console.log('parseAnnounceResp - action : ', announceResp.action ,"\ntransaction id : " , announceResp.transactionId, "\nseeders : " , announceResp.seeders , "\leechers: " , announceResp.leechers);
